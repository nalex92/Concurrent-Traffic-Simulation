...
void TrafficLight::cycleThroughPhases()
{
  ...
  std::cout << "Traffic Light " << _id << "started" << cycle_duration << "\n";
  ...
  while (true)
  {
    ...
    if (timeSinceUpdate >= cycle_duration)
    {
      ...
      if (_currentPhase == TrafficLightPhase::red)
      {
        ...
        std::cout << "Traffic Light " << _id << "Green\n";
      }
      else
      {
        _currentPhase = TrafficLightPhase::red;
        std::cout << "Traffic Light " << _id << "Red\n";
      }
      ...
      // choose randomly cycle duration for next cycle
